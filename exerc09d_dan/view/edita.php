...
<body>
    ...
    <p>Aqui é possível alterar seu contato de Email.</p>
    <form action="?funcao=editar" method="post">
        ...
        placeholder='Preencha o novo nome do contato' required='required' value='<?= $contato->getNome(); ?>'>

        <label for="email">E-mail:</label>
        <input name="email" id="email" type="email"
        placeholder="Preencha o email" required="required" value="<?= $contato->getEmail(); ?>"/>
